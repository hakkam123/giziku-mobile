...
class SimulationDaysScreen extends StatefulWidget {
  ...
  const SimulationDaysScreen({
    super.key,
    required this.budget,
  });

  @override
  State<SimulationDaysScreen> createState() =>
      _SimulationDaysScreenState();
}

class _SimulationDaysScreenState
    extends State<SimulationDaysScreen> {
  ...
  void goToNext() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => SimulationPeopleScreen(
